...
public class BestFit {
    static void bestFit(int blockSize[], int m, int processSize[], int n, int remainingBlockSize[]) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (bestIdx != -1) {
                ...
                remainingBlockSize[bestIdx] = blockSize[bestIdx];
            }
        }
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (allocation[i] != -1) {
                System.out.print((allocation[i] + 1) + "\t\t" + remainingBlockSize[allocation[i]]);
            } else {
    ...
    public static void main(String[] args) {
        ...
        bestFit(blockSize, m, processSize, n, remainingBlockSize);
